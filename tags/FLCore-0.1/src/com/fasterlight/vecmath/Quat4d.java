 ...
 * @version specification 1.1, implementation $Revision: 1.1 $, $Date: 2004-01-14 02:48:42 $
 * @author Kenji hiranabe
 */
public class Quat4d extends Tuple4d implements Serializable {
/*
 * $Log: Quat4d.java,v $
 * Revision 1.1  2004-01-14 02:48:42  Steve
 * ported to JOGL
 *
 * Revision 1.2  2001/05/09 15:49:37  hugg
 * oops i am a dummkop
 *
 * Revision 1.1.1.1  1999/11/25 10:55:38  hugg
 *
 *
 ...
 */
	...
	if (Double.isNaN(n))                                                           
	{
      System.out.println("Norm err: " + this);
      return;                                                                     
   }  
	// zero-div may occur.
	x = q1.x/n;
